...
const Setting = ({ handleImage }) => {
	...
	const { handleCheckOtp, handleCreatePin, handlePassword } =
	...
	return (
		<div className="w-full">
			...
			<button
				className="w-full px-3 py-2.5 flex justify-between"
				onClick={() => handleImage()}
			>
			...
			<div className="w-full px-3 py-2 flex justify-center">
				<button
					onClick={() => logout()}
					className="mx-1 text-xl p-2 justify-center px-6 text-center bg-green-500 text-white rounded-md"
				>
					Log Out
				</button>
			</div>
