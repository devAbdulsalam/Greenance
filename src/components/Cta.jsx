	...
	return (
		<section className="relative z-10 overflow-hidden bg-primary py-16 px-8">
			<div className="container">
				<div className="-mx-4 flex flex-wrap items-center md:w-11/12 md:mx-auto md:py-10">
					<div className="w-full px-4 lg:w-1/2">
						<div className="text-center lg:text-left">
							<motion.div
								...
								className="mb-10 lg:mb-0 text-white z-10"
							>
								<h1 className="mt-0 mb-3 text-3xl lg:text4xl font-bold leading-tight sm:text-4xl sm:leading-tight md:text-[40px] md:leading-tight text-white ">
					...
					<div className="w-full px-4 lg:w-1/2">
						...
						>
							<Link
								to={'/'}
								className="font-semibold rounded-md mx-auto inline-flex items-center justify-center bg-white py-4 px-9 text-primary hover:bg-primary hover:text-white hover:border-white hover:border hover:bg-opacity-90 duration-500 ease-in-out"
							>
								Apply now
							</Link>
						</motion.div>
