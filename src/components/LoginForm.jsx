			...
			>
				<div className="relative">
					<input
						...
						className="peer h-10 w-full p-4 text-lg rounded-sm border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-green-500 bg-gray-100"
					/>
					{errors.phone && (
				...
				<div className="mt-10 relative">
					<input
						...
						className="peer h-10 w-full p-4 appearance-none text-lg rounded-sm border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none  focus:border-green-500 bg-gray-100"
					/>
					{errors.password && (
