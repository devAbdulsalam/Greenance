				...
				<div className="container px-4 mx-auto">
					<div className="-mx-4 flex flex-wrap justify-between">
						...
						<div className="px-4 my-4 w-full sm:w-auto">
							...
							<a
								href="#"
								className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-primary hover:border-primary"
							>
								<svg
							...
							<a
								href="#"
								className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-primary hover:border-primary"
							>
								<svg
									className="w-4 h-4 fill-current"
									xmlns="http://www.w3.org/2000/svg"
				...
				<div className="container mx-auto px-4">
					<div className="-mx-4 flex flex-wrap justify-between">
						<div className="px-4 w-full text-center sm:w-auto sm:text-left">
							Copyright © 2023 - 2024 Greenance. All Rights Reserved.
						</div>
						<div className="px-4 w-full text-center sm:w-auto sm:text-left">
							Made by{' '}
							<a href="https://devabdulsalam.vercel.app" target="blank">
								devAbdulsalam
							</a>
							.
						</div>
