		...
		<div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center bgImage">
			...
			<div className="w-full px-24 z-10 text-center text-white">
				...
				<button
					...
					className="rounded-full mt-16 px-10 py-3 text-white text-lg font-bold capitalize border-white border-2  hover:bg-green-500 hover:border-green-500 transition-all ease-out duration-500"
				>
